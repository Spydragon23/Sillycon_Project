...
export const AGENTS: Agent[] = [
  {
    ...
    avatar: "A",
    class: "Data Excavator",
    classIcon: "database",
    description:
      "Specializes in recovering deleted, encrypted, or buried data from any node in the network. Patience is a weapon.",
    stats: [
      { label: "Stealth", value: 42 },
      { label: "Decryption", value: 95 },
      { label: "Memory", value: 88 },
      { label: "Instability", value: 15 },
      { label: "Influence", value: 60 },
    ],
    threat: "LOW",
  },
  {
    ...
    avatar: "J",
    class: "Chaos Operative",
    classIcon: "shuffle",
    description:
      "Unpredictable agent that excels at dismantling systems through creative misdirection. Results guaranteed; side effects unknown.",
    stats: [
      { label: "Stealth", value: 28 },
      { label: "Decryption", value: 55 },
      { label: "Memory", value: 33 },
      { label: "Instability", value: 97 },
  ...
  },
  {
    ...
    avatar: "W",
    class: "Surveillance Phantom",
    classIcon: "eye",
    description:
      "Silent observer who monitors all network activity within a sector. Sees everything, reports selectively.",
    stats: [
      { label: "Stealth", value: 91 },
      { label: "Decryption", value: 40 },
      { label: "Memory", value: 75 },
      { label: "Instability", value: 58 },
